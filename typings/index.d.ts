...
declare namespace SDK {
  ...
  type LivedataDoc = {
    ...
    updatedBy: string;
    sysType: string;
    isSkinIrritation: string;
    skinIrritationAttach: string;
    hasCorrosiveDrug: string;
    hasCorrosiveDrugAttach: string;
    adverseReactions: string;
    adverseReactionsAttach: string;
    isAdverseReactionsRecoverable: string;
    isAdverseReactionsRecoverableAttach: string;
    contraindications: string;
    contraindicationsAttach: string;
    otherSafeInstruction: string;
    otherSafeInstructionAttach: string;
    relatedCases: string;
    relatedCasesAttach: string;
    feedback: string;
    feedbackAttach: string;
    researchEvidence: string;
    researchEvidenceAttach: string;
    patientRecheck: string;
    patientRecheckAttach: string;
    otherEffectiveness: string;
    otherEffectivenessAttach: string;
    education: string;
    educationAttach: string;
    training: string;
    trainingAttach: string;
    trainingTime: string;
    trainingTimeAttach: string;
    treatmentCost: string;
    treatmentCostAttach: string;
    treatmentTimeCost: string;
    treatmentTimeCostAttach: string;
    otherAccessibility: string;
    otherAccessibilityAttach: string;
    implementationTime: string;
    implementationTimeAttach: string;
    implementationArea: string;
    implementationAreaAttach: string;
    hasOperatingSpecifications: string;
    hasOperatingSpecificationsAttach: string;
    researchMaterials: string;
    researchMaterialsAttach: string;
    researchTopics: string;
    researchTopicsAttach: string;
    relatedRewards: string;
    relatedRewardsAttach: string;
    clinicsScale: string;
    clinicsScaleAttach: string;
    releatedProducts: string;
    releatedProductsAttach: string;
    otherMaturity: string;
    otherMaturityAttach: string;
    technologicalInnovation: string;
    technologicalInnovationAttach: string;
    effectAdvantage: string;
    effectAdvantageAttach: string;
    securityAdvantage: string;
    securityAdvantageAttach: string;
    economyAdvantage: string;
    economyAdvantageAttach: string;
    otherAdvantage: string;
    otherAdvantageAttach: string;
  };
  type Livedata = {
    id: string;
    updatedAt: string;
